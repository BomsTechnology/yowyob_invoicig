        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="xl md:text-2xl lg:text-3xl font-bold tracking-widest">
                        {{-- <x-application-logo class="block h-10 w-auto fill-current text-gray-600" /> --}}

                        <span class="text-blue-500">Yowyob</span> Invoicing
                    </a>
                </div>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center text-md font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                            ...
                            <span class="ml-1">{{ Session::get('loginUser') }}</span>
                            <div class="ml-1">
                    ...
                    <x-slot name="content">
                        <!-- Authentication -->
                        <a href="{{ route('mylogout') }}" class="ml-8">Se deconnecter</a>
                    </x-slot>
                </x-dropdown>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <a href="{{ route('mylogout') }}">Se deconnecter</a>
            </div>
        </div>
    </div>
</nav>
